...
|--------------|---------------------|-------|
| **Graph-Based E-Commerce Recommender System** | • Neo4j Graph Database<br>• Cypher Query Language<br>• Jaccard Similarity Index<br>• Collaborative Filtering<br>• Python (pandas, neo4j, networkx)<br>• Surprise Library Validation<br>• SVD (Singular Value Decomposition)<br>• Batch Processing with UNWIND<br>• Network Visualization<br>• Real-time Recommendation Engine<br>• Data Cleaning Pipeline (10 steps)<br>• Graph Traversal Algorithms | [📄 Summary](https://github.com/masterA88/project-docs/blob/main/graph_recommender_system.pdf) \| [💻 Code](#) \|
